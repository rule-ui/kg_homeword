...
class TransE:
    ...
    def training_run(self, epochs=1, nbatches=100, out_file_title = ''):
        ...
        with codecs.open(out_file_title +"TransE_entity_" + str(self.dimension) + "dim_batch" + str(batch_size), "w", encoding='utf-8') as f1:
        ...
        with codecs.open(out_file_title +"TransE_relation_" + str(self.dimension) + "dim_batch" + str(batch_size), "w", encoding='utf-8') as f2:
...
if __name__ == '__main__':
    ...
    transE.training_run(out_file_title="./data/")
